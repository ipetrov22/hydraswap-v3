...
export function swapErrorToUserReadableMessage(error: any): ReactNode {
  ...
  switch (reason) {
    ...
    case 'UniswapV2: K':
      return (
        <Trans>
          The Hydraswap invariant x*y=k was not satisfied by the swap. This usually means one of the tokens you are
    ...
    case 'STF':
      return (
        <Trans>
          ...
          transfer and rebase tokens are incompatible with Hydraswap V3.
        </Trans>
      )
    case 'TF':
      return (
        <Trans>
          ...
          rebase tokens are incompatible with Hydraswap V3.
        </Trans>
      )
    default:
      if (reason?.indexOf('undefined is not an object') !== -1) {
        ...
        return (
          <Trans>
            ...
            and rebase tokens are incompatible with Hydraswap V3.
          </Trans>
        )
      }
      return (

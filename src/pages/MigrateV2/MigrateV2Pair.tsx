        ...
        <AutoColumn gap="lg">
          ...
          {noLiquidity && (
            <BlueCard style={{ display: 'flex', flexDirection: 'column', alignItems: 'center' }}>
              ...
              >
                <Trans>
                  You are the first liquidity provider for this Hydraswap V3 pool. Your liquidity will migrate at the
                  current V2 price.
                </Trans>
              </ThemedText.DeprecatedBody>
          ...
          {largePriceDifference ? (
            <YellowCard>
              ...
              <ThemedText.DeprecatedBody fontSize={14} style={{ marginTop: 8, fontWeight: 400 }}>
                <Trans>
                  You should only deposit liquidity into Hydraswap V3 at a price you believe is correct. <br />
                ...
                {chainId && refund0 && refund1 ? (
                  <ThemedText.DeprecatedBlack fontSize={12}>
                    <Trans>
                      ...
                      {chainId && WRAPPED_NATIVE_CURRENCY[chainId]?.equals(token0) ? 'HYDRA' : token0.symbol} and{' '}
                      {formatCurrencyAmount(refund1, 4)}{' '}
                      {chainId && WRAPPED_NATIVE_CURRENCY[chainId]?.equals(token1) ? 'HYDRA' : token1.symbol} will be
